...
class EndlessWaveRunner:
    def __init__(self):
        ...
        pygame.display.set_caption("Endless Wave Runner - Vertical")
    ...
    def handle_events(self):
        """
        Procesa la entrada del usuario (teclado).
        Flecha Izquierda -> Va diagonal izquierda.
        Flecha Derecha -> Va diagonal derecha.
        Flecha Arriba -> Va recto.
        """
    ...
    def draw_ship(self):
        ...
        rad = pygame.math.Vector2(0, -1).rotate(angle).angle_to(pygame.math.Vector2(0, -1))
