...
from components.pretrainedModels.MiRepNet.utils.channel_list import BNCI2014001_chn_names, BNCI2014004_chn_names, BNCI2015001_chn_names, AlexMI_chn_names
