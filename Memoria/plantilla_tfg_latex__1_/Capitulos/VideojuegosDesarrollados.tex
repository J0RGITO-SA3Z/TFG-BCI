...
Como se ha mencionado anteriormente, se hizo uso de un LLM para la implementación, concretamente Gemini\footnote{\url{https://gemini.google.com}}. El prompt utilizado para la generación fue el siguiente:
...
El prompt utilizado para la generación mediante el LLM Gemini\footnote{\url{https://gemini.google.com}} fue:
...
La implementación, de la misma forma que con los juegos, se realizó utilizando un LLM (Gemini\footnote{\url{https://gemini.google.com}}). Se le proporcionó el siguiente prompt:
...
Partiendo de la base que generó el LLM, fue necesario hacer una pequeña modificación para hacer las flechas completamente simétricas y se implementaron a mano los métodos descritos en el párrafo anterior al prompt.
