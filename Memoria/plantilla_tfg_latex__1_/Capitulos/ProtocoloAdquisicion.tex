...
Se mantuvo la misma configuración de equipamiento utilizada en los experimentos piloto (véase la Sección~\ref{subsec:equipamiento}), empleando el dispositivo EEG con la misma configuración de 17 electrodos, 15 de medición, 1 de referencia y 1 de \textit{bias}
...
\label{subsubsec:estructura_grabación}

Se  siguió la misma estructura de secuencia que en los experimentos piloto  (véase la Sección~\ref{subsec:estructuraGrabacion}).
