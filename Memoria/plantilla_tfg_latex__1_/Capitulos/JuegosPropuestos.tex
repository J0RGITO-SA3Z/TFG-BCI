\chapter{Juegos propuestos}
\label{cap:juegosPropuestos}
...
\section{\textit{Endless Wave Runner}}
\label{sec:endless_wave_runner}
...
\section{\textit{Project Arrows}}
\label{sec:project_arrows}
...
\section{\textit{Benchmark} visual}
\label{sec:benchmark_visual}
