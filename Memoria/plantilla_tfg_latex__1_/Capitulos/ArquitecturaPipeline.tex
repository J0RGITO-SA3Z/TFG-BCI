...
\begin{itemize}
	...
	Una vez finalizada la recolección de datos, se preprocesan los datos en el \textbf{proceso 1}, se calcula la matriz de \hyperref[subsec:alineamiento_euclideo]{alineamiento euclideo} y se realiza \textit{fine-tuning} en el \hyperref[sec:modelo]{modelo}. Tras esto, se inicia la \textbf{fase 2}. 
