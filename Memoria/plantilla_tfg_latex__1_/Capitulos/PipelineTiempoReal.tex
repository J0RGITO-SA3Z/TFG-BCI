...
Además, se diseñaron y desarrollaron varios juegos experimentales que sirvieron para comprobar la capacidad de integración del sistema en un entorno de tiempo real. Estos juegos incorporan mecanismos de asistencia adicional, orientados a reducir los errores derivados del propio ruido de las señales EEG, de las fluctuaciones del modelo de clasificación y de la experiencia del usuario con \textit{motor imagery}.
...
\label{subsubsec:endless_wave_runner}
...
\label{subsubsec:project_arrows}
...
\begin{figure}[h]
    ...
    \caption{Visualización gráfica en ventana del benchmark de doble flecha.}
