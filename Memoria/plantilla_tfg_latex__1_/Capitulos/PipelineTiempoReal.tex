...
El primero proceso se encargada de crear los demás procesos y de recoger los datos del dispositivo EEG y retransmitirlos al segundo.
...
\begin{itemize}
    ...
    \item \textbf{\textit{Score} ponderado}:  Para cada predicción generada por el modelo, se calcula un valor de confianza a partir de la diferencia absoluta entre las probabilidades asociadas a ambas clases:
    ...
    Este método se mostró especialmente efectivo para mejorar la estabilidad de las predicciones en tiempo real, proporcionando una experiencia de usuario más fluida,consistente y menos inestable.
\end{itemize}
