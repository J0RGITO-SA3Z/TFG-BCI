\chapter{Filtros aplicados al flujo de predicciones}
\label{cap:filtrosFlujoPredicciones}

\section{Filtros de decisión}
\label{sec:filtros_decision}
...
\section{Filtros de ayuda integrados en los juegos}
\label{sec:filtros_ayuda}
