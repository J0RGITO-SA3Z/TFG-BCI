...
MiRepNet es un modelo de aprendizaje profundo basado en la arquitectura transformer y especializado en EEG que proporciona pesos preentrenados sobre 50.355 \textit{trials} y clasifica 4 clases de imaginación motora siendo estas: mano izquierda, mano derecha, pies y lengua.
...
\subsubsection{Congelación del transformer}
...
\begin{table}[h]
	...
	\begin{tabular}{lccc}
		...
		\hline
	\end{tabular}
	\caption{\textit{Accuracy} (media $\pm$ desv. típ.) con y sin congelación del transformer durante el \textit{fine-tuning}.}
