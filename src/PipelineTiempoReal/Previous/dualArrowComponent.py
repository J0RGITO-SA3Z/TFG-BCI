...
if __name__ == "__main__":
    ...
    # Ventana modificable en tamaño (RESIZABLE)
    screen = pygame.display.set_mode((800, 400), pygame.RESIZABLE)
    pygame.display.set_caption("Componente de Flechas Direccionales")
    clock = pygame.time.Clock()

    # Instanciamos nuestro componente
    arrows = DualArrowComponent(left_pct=0, right_pct=0)
