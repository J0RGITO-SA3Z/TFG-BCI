...
def main():
    experimento = ExperimentoVisual()
    experimento.open()
    experimento.draw_text("+", (0, 255, 0))
    pygame.time.wait(3000)
    experimento.draw_arrow("left", (0, 255, 0))
    pygame.time.wait(3000)
    experimento.draw_arrow("right", (0, 255, 0))
    pygame.time.wait(3000)
    experimento.draw_arrow("down", (0, 255, 0))
    pygame.time.wait(3000)
    experimento.draw_text("", (0, 255, 0))
    pygame.time.wait(3000)
